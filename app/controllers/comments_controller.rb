class CommentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @comment.update(comment_params)
        format.html { redirect_to photo_path(@photo), notice: 'Comment was successfully updated.' }
  ...
  def destroy
    @comment.destroy
    respond_to do |format|
      format.html { redirect_to photos_url, notice: 'Comment was successfully destroyed.' }
